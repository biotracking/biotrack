...
int main(int argc, char *argv[])
{
   ...
   AbosPool capture_pool, scaled_pool;//, output_pool;
   ...
   image_capture.setImagePool(&scaled_pool, &capture_pool);    // write
	//BG averaging
   ...
   pool_vec.append(&scaled_pool);

   QApplication a(argc, argv);
   MainWindow w(&capture_pool, thread_vec, pool_vec, fps);
